import 'package:ankit/screens/physicss/physics_chapterIX.dart';
import 'package:ankit/screens/physicss/physics_chapterX.dart';
import 'package:ankit/screens/physicss/physics_chapterXI.dart';
import 'package:ankit/screens/physicss/physics_chapterXII.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class PhysicsClass extends StatelessWidget{
  const PhysicsClass({super.key});
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            InkWell(
              onTap: (){
                Navigator.push(context, MaterialPageRoute(builder: (context)=>const PhysicsChapterIX()));
              },
              child: Container(
            ...
            InkWell(
              onTap: (){
                Navigator.push(context, MaterialPageRoute(builder: (context)=>const PhysicsChapterX()));
              },
              child: Container(
                width:MediaQuery.of(context).size.width*.457,
                height: 100,
            ...
            Row(
              ...
              children: [
                InkWell(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>const PhysicsChapterXI()));
                  },
                  child: Container(
                    width:MediaQuery.of(context).size.width*.457,
                    height: 100,
                ...
                InkWell(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>const PhysicsChapterXII()));
